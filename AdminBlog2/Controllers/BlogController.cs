...
using System.IO;
using AdminBlog2.Filter;

namespace AdminBlog2.Controllers
{
    [UserFilter]
    public class BlogController : Controller
    {
        ...
        public async Task<IActionResult> Save(Blog model){
            if(model != null){
                var file = Request.Form.Files.First();//C:\Users\USER\Desktop\Blog2\MyBlog2\wwwroot
                string savePath = Path.Combine("C:","Users","USER","Desktop","Blog2","MyBlog2","wwwroot","img");
